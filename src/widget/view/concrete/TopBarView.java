...
class TopBarView extends View {
    ...
    protected void createTextVariables() {    
      ...
      addTextVariable(new TextVariable(new Point(0, 0), LTUtil.addPoint(new Point(150,30), getOffset()), color(255), 24));   
      addTextVariable(new TextVariable(new Point(0, 0), LTUtil.addPoint(new Point(270,30), getOffset()), color(255), 24));  
      addTextVariable(new TextVariable(new Point(0, 0), LTUtil.addPoint(new Point(390,30), getOffset()), color(255), 24)); 
      addTextVariable(new TextVariable(new Point(0, 0), LTUtil.addPoint(new Point(width - 100, 30), getOffset()), color(255), 24));
    }
